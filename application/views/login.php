...
<!-- Header -->
<div class="header bg-gradient-primary py-9 py-lg-8" >
<div class="container" >
<div class="header-body text-center mb-7">
<div class="row justify-content-center" >
<div class="col-lg-5 col-md-6">
<h1 class="text-white">IBS</h1>
<p class="text-lead text-light">Intelligence Business Solutions.</p>
</div>
</div>
</div>
</div>
...
© 2019 <a href="https://www.creative-tim.com/product/argon-dashboard" class="font-weight-bold ml-1" target="_blank">IBS SOFTWARE</a>
</div>
</div>
