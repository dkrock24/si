<script type="text/javascript">
    ...
    function drawTable(datos, entidad, table_intermedia) {
        ...
        var data;
        var num = 1;
        var html = '<thead style="background:#cfdbe2"><tr><th scope="col"></th><th>Cod</th><th>Entidad</th> <th>Impuesto</th> <th>Porcentaje</th> <th>SRN</th> <th>A_P</th> <th>A_C</th> <th>A_P</th> <th>A_GBE</th><th>Es</th><th>Ex</th><th>Co</th><th>Valor</th><th>Combustible</th><th>Estado</th> <th>Opciones</th> </tr></thead>';
        $.each(datos['impuesto_option'], function(i, item) {
            ...
            html += "<td>" + item.es_combustible + "</td>";
