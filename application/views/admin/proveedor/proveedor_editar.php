                        ...
                        <form class="form-horizontal" enctype="multipart/form-data" name="cliente" action='../update' method="post">
                            ...
                            <div class="panel b">
                                <div class="panel-heading">
                                    ...
                                    <h4 class="m0">Editar Proveedor</h4>
                                    <small class="text-muted">Editar Proveedor Selecionado.</small>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" id="empresa" name="empresa" placeholder="Empresa" value="<?php echo $proveedor[0]->empresa ?>">
