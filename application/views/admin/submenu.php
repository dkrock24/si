    ...
    <div class="col-lg-12">
        <div class="panel panel-white">
            <div class="panel-heading">
                <h3 class="panel-title">Sub Menu : <?php echo $submenus[0]->nombre_menu; ?> <a href="../index">Atras</a></h3>
			                            	...
			                            	<div class="input-group">                                
				                                <div class="input-group-btn">
				                                    ...
				                                    <ul class="dropdown-menu">
				                                        <li><a href="submenu/<?php echo $sub->id_submenu; ?>">Editar</a></li>
				                                        <li><a href="submenu/<?php echo $sub->id_submenu; ?>">Eliminar</a></li>
				                                    </ul>
				                                </div>
                            				</div>
			                            </td>
