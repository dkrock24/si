    ...
    <div class="content-wrapper">            
        ...
        <h3 style="height: 50px; font-size: 13px;">                
            ...
            <a href="" style="top: -12px;position: relative; text-decoration: none">
                <button type="button" style="top: 0px; position: relative;" class="mb-sm btn btn-info btn-outline">Editar</button>
            </a>
        </h3>
        <div class="row">
            <div class="col-lg-12">
                            ...
                            <div class="panel-body menuContent"> 
                                    ...
                                    <form class="form-horizontal" id='giro' method="post">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" required class="form-control" id="nombre_giro" name="nombre_giro" value="<?php echo $giros[0]->nombre_giro; ?>" placeholder="Nombre" value="">
                                            </div>
                                        </div>   
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" required class="form-control" id="codigo_giro" name="codigo_giro" value="<?php echo $giros[0]->codigo_giro; ?>" placeholder="Codigo" value="">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <div class="col-sm-offset-2 col-sm-10">
                                            <input type="button" name="<?php echo base_url() ?>admin/giros/crear" data="giro" class="btn btn-warning enviar_data" value="Guardar">
                                            </div>
                                        </div>
                                    </form>
                                    </div>
