												...
												<div class="panel-heading">
													...
													<div class="panel-body">
														<div class="row">
															...
															<div class="col-md-6">
																<b>Tipo </b>
																<select class="form-control" name="factura_tipo_documento">
															...
															<div class="col-md-6">
																<b>Cliente </b>
																<select class="form-control" name="factura_cliente">
																	<option value="0">Todos</option>
																	<?php
															...
															<div class="col-md-6">
																<b>Sucursal</b>
																<select class="form-control" name="factura_sucursal">
																	<option value="0">Todos</option>
																	<?php
															...
															<div class="col-md-6">
																<b>Sucursal</b>
																<select class="form-control" name="factura_empresa">
																	<option value="0">Todos</option>
																	<?php
