    ...
    <div class="content-wrapper">  
        <h3 style="height: 50px; font-size: 13px;">  
            <a href="index" style="top: -12px;position: relative; text-decoration: none">
                <button type="button" class="mb-sm btn btn-pill-left btn-primary btn-outline"> Cargos</button> 
            </a> 
        ...
        <div class="row">
            <div class="col-lg-12">
                        ...
                        <div id="panelDemo10" class="panel">    
                            ...
                            <div class="panel-heading menuTop">Nuevo Cargo Laboral : <?php //echo $onMenu[0]->nombre_submenu ?> </div>
