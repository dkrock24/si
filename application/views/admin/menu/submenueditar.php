    ...
    <section>
        ...
        <div class="content-wrapper">  
            <h3 style="height: 50px; font-size: 13px;">  
                ...
                <a name="admin/menu/submenu/<?php echo  $onMenu[0]->id_menu; ?>" style="top: -12px;position: relative; text-decoration: none" class="holdOn_plugin">
                    ...
                    <div class="panel menu_title_bar">
                        ...
                        <div class="panel-heading menuTop">Editar Sub Menu : <?php echo  $onMenu[0]->nombre_submenu; ?> </div>
                            <div class="panel-body menuContent">
                                <div class="row">
                                    <div class="col-lg-6">
                                        <form class="form-horizontal" id='update_sub_menu' method="post">
                                            ...
                                            <div class="form-group">
                                                <div class="col-sm-offset-3 col-sm-9">
                                                <input type="button" name="<?php echo base_url() ?>admin/menu/update_sub_menu/<?php echo $onMenu[0]->id_menu; ?>" data="update_sub_menu" class="btn btn-success enviar_data" value="Guardar">
                                                </div>
                                            </div>
