    ...
    <div class="content-wrapper">  
        <h3 style="height: 50px; font-size: 13px;">  
            <a name="data/integrador/index" style="top: -12px;position: relative; text-decoration: none" class="holdOn_plugin">
                <button type="button" class="mb-sm btn btn-success"> Integrador</button> 
            </a> 
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" id="sucursal" name="sucursal" placeholder="Sucursal" value="<?php //echo $onMenu[0]->url_submenu ?>">
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-offset-2 col-sm-10">
                                        <input type="button" name="<?php echo base_url() ?>data/integrador/crear" data="integrador" class="btn btn-success enviar_data" value="Guardar">
                                        </div>
                                    </div>
