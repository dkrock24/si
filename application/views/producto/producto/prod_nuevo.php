    ...
    <div class="content-wrapper">            
        ...
        <div class="row" style="margin-top: -50px !important;">
            <div class="col-lg-12">
                ...
                <form class="form-horizontal" enctype="multipart/form-data" id='producto' name='producto_formulario' id="producto_formulario" method="post" >
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" name="producto_asociado" id="" onClick="producto_asociado();" class="form-control" value="">
                                            </div>
                                            <div class="col-sm-1"></div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            <div class="col-sm-offset-3 col-sm-3">
                                                <input type="button" name="<?php echo base_url() ?>producto/producto/crear" data="producto" class="btn btn-success enviar_data" value="Guardar">
                                            </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12"> 
                            <div id="" class="panel panel-default" style="margin-top: 10px !important;">
                                ...
                                <div class="panel-body menuContent">  
                                    <div class="row">
                                        <p class="form-horizontal giro_atributos"></p>
                                    </div>
                                </div>
                            </div>
                        </div>
