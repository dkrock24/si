                                        ...
                                        <div class="col-lg-3 col-md-3">
                                            <div class="form-group has-success">
                                                ...
                                                <select class="form-control" name="bodega_origen" id="bodega_select">
                                                    ...
                                                    foreach ($bodega as $b) {
                                                        if ($b->id_bodega == $traslado[0]->bodega_origen) {
                                                    ?>
                        ...
                        <table class="table table-sm table-hover" style="margin-bottom: 0px;">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <span class="btn bg-green" style="font-size: 25px;" name="save_traslado" id="guardar_orden"><i class='fa fa-save'></i> <span style="font-size:18;"> [ ]</span> </span>
