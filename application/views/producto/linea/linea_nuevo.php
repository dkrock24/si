    ...
    <section>
        ...
        <div class="content-wrapper">
            ...
            <div class="panel panel-default">
                <div class="panel-heading">Nueva Linea</div>
                                            ...
                                            <div class="panel-body">
                                                <form class="form-horizontal" action='save_linea' method="post">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <input type="text" class="form-control" id="tipo_producto" name="tipo_producto" value="<?php //echo $roles[0]->role ?>">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <input type="text" class="form-control" id="descripcion_tipo_producto" name="descripcion_tipo_producto" value="<?php //echo $roles[0]->pagina ?>">
