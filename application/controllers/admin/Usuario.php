...
// Start  **********************************************************************************
	...
	public function column(){
		...
		$column = array(
			'#','Usuario','Password','Hora Inicio','Hora fin','Encargado', 'Rol', 'Empleado', 'Estado'
		);
		return $column;
	}
	...
	public function fields(){
		$fields['field'] = array(
			'nombre_usuario','contrasena_usuario','hora_inicio','hora_salida','encargado','id_rol','Empleado','estado'
		);
