...
// Start PAIS **********************************************************************************
	...
	public function crear(){
		// Insert pais
		$this->Categorias_model->crear_atributo( $_POST );
	...
	public function edit( $id_prod_atributo ){
		...
		$data['menu'] = $this->Menu_model->getMenu( $id_rol );		
		$data['atributo'] = $this->Categorias_model->get_atributo_id( $id_prod_atributo );
	...
	public function actualizar(){
		// Insert pais
		$this->Categorias_model->actualizar_atributo( $_POST );
